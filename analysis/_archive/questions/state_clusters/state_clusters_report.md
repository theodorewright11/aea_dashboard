...
![Risk tier bars by state](risk_profile/figures/risk_tier_bars.png)
...
![GWA heatmap by state and cluster](activity_signature/figures/gwa_heatmap.png)
...
![Overall agentic intensity by state](agentic_profile/figures/overall_agentic_bar.png)
...
![Overall gap ratio by state](adoption_gap/figures/overall_gap_bar.png)
...
![ARI heatmap between all 5 clusterings](cluster_convergence/figures/ari_heatmap.png)
![State stability scores](cluster_convergence/figures/stability_bar.png)
