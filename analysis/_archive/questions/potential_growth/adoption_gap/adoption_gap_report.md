...
![Confirmed vs Ceiling — Every Occupation](figures/confirmed_vs_ceiling_scatter.png)
...
![Confirmed vs Ceiling — Major Category](figures/occ_gap_major.png)
...
![Minor Categories — Workers Gap](figures/occ_gap_minor.png)
...
![Occupations — Workers Gap](figures/occ_gap_occupation.png)
...
![GWA Level — Confirmed vs Ceiling](figures/wa_gap_gwa.png)
...
![IWA Level — Top 20 by Workers Gap](figures/wa_gap_iwa.png)
...
![Config Sensitivity — All Five Datasets](figures/config_robustness.png)
