...
![Top 15 GWAs by workers affected (all_confirmed)](figures/our_gwa_rankings.png)
...
![AEI's 57% augmentative / 43% automative split](figures/augment_vs_automate.png)
...
![ChatGPT vs Copilot GWA distributions](figures/platform_gwa_alignment.png)
