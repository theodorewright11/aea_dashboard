...
![Workers Affected by Sector — Agentic Ceiling](figures/major_workers_agentic_ceiling.png)

![% Tasks Affected by Sector — Agentic Ceiling](figures/major_pct_agentic_ceiling.png)

![Agentic vs Conv. Baseline Delta by Sector](figures/agentic_vs_conv_delta.png)

![Sector Exposure Heatmap (4 datasets)](figures/sector_heatmap.png)
