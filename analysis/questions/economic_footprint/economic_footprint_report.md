...
![Wages Affected by Sector](sector_footprint/figures/treemap_wages.png)
...
![Elements Where AI Leads (vs typical occ need)](skills_landscape/figures/ska_leads_ai_eco_mean.png)

![Elements Where Humans Lead (vs typical occ need)](skills_landscape/figures/ska_leads_human_eco_mean.png)

![Top Technology Categories by Exposed Workers](skills_landscape/figures/tech_workers_affected.png)
