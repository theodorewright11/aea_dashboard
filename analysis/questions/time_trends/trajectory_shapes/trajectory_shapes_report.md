...
![Trajectory Type Mix by Sector](figures/trajectory_type_by_sector.png)
...
![Trajectory Shape: Starting Level vs Total Growth](figures/trajectory_scatter.png)
...
![Example Occupation Trajectories](figures/trajectory_example_lines.png)
