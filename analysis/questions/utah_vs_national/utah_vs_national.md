...
![Exposure Tier Comparison](figures/exposure_tier_comparison.png)
...
![Utah's Largest High-Exposure Occupations](figures/utah_largest_high_exposure.png)
...
4. **Utah's top high-exposure occupations include more tech roles** — Search Marketing Strategists, Computer Systems Engineers, Web Administrators, Online Merchants — that don't appear in the national top 20 because they're proportionally smaller nationally.
...
| `results/exposure_tier_comparison.csv` | Usage-confirmed tier distribution, both geos |
| `results/exposure_tier_comparison_ceiling.csv` | Ceiling tier distribution, both geos |
| `results/utah_largest_high_exposure.csv` | Utah's top 20 moderate+high exposure occupations |
| `results/exposure_major_moderate_high_comparison.csv` | Moderate+high exposure share by major, both geos |
