...
![Risk tier distribution by state](figures/risk_tier_bars.png)
...
![Cluster profiles by risk tier](figures/cluster_profiles.png)
...
![Sector composition vs. risk profile clusters](figures/vs_sector_comp.png)
