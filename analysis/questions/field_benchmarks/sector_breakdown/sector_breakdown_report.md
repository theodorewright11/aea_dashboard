...
![Top 10 sectors by workers affected (all_confirmed)](figures/our_sector_rankings.png)
...
![Cross-source sector comparison: our pct vs Copilot applicability](figures/cross_source_sectors.png)
...
![External sources: AEI task categories and ChatGPT work-use types](figures/external_task_breakdown.png)
