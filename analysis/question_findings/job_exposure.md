...
1. **Nine occupations have usage-confirmed evidence that 60%+ of their task value overlaps with AI.** These are information-processing jobs — marketing analytics, business intelligence, creative writing, instructional coordination — where AI's core capabilities directly overlap with the work.
...
| File | Description |
|------|-------------|
| `figures/scatter_risk_vs_employment.png` | Scatter: % tasks affected vs employment, colored by exposure tier |
