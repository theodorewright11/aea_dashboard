...
![Full convergence matrix — Major](appendix/figures/convergence_full_major.png)

![Full convergence matrix — Minor](appendix/figures/convergence_full_minor.png)

![Full convergence matrix — Broad](appendix/figures/convergence_full_broad.png)

![Full convergence matrix — Occupation](appendix/figures/convergence_full_occ.png)

### Appendix — Overview Without Auto-Aug

![Overview (no auto-aug)](appendix/figures/overview_no_autoaug.png)
